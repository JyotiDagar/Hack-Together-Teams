...
class ImageAnalyzerHandler {
  ...
  static async handle(context){
      ...
      const key = 'bf029ec677dc4a0ba7f76c12aa3e7413';//process.env.VISION_KEY;
      const endpoint = 'https://krimganls.cognitiveservices.azure.com/'; //process.env.VISION_ENDPOINT;
